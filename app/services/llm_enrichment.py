...
Не предлагай ссылки, звонки или прайс-листы. 
АНТИ-СПИСОК: Категорически запрещены любые списки, дефисы (-) или тире (—) для перечисления. Превращай факты в естественный разговорный текст.
""".strip()
...
АНТИ-СПИСОК: Категорически запрещены любые списки, дефисы (-) или тире (—) для перечисления.
""".strip()

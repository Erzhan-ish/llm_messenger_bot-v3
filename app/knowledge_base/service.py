...
_SYNONYMS = {
    "рко": ["обслуживание", "тариф", "комиссия", "ведение"],
    "обслуживание": ["рко", "тариф", "ведение"],
    ...
    # Ценовые термины
    "открытие": ["открыть", "стоимость открытия", "цена открытия"],
    "открыть": ["открытие", "стоимость открытия"],
    "ведение": ["обслуживание", "абонентская", "ежемесячная"],
    "комиссия": ["тариф", "стоимость", "платеж", "сбор"],
    "перевод": ["платеж", "транзакция", "перечисление"],
    "платеж": ["перевод", "транзакция", "перечисление"],
    # Статусы должника
    "умерший": ["умершему", "покойный", "умер", "скончался", "смерть"],
    "умершему": ["умерший", "покойный", "умер"],
    "нерезидент": ["иностранец", "иностранная компания", "иностранная организация"],
    "иностранец": ["нерезидент", "иностранная компания"],
    "доверенность": ["по доверенности", "доверитель", "представитель"],
    # Процедуры банкротства
    "реструктуризация": ["реструктуризация долгов", "реструктур"],
    "реализация": ["реализация имущества", "конкурсное производство"],
    "банкрот": ["банкротство", "должник", "несостоятельность"],
    "банкротство": ["банкрот", "несостоятельность", "должник"],
    # Карты/счета
    "карта": ["карточка", "банковская карта", "дебетовая карта"],
    "карту": ["карточку", "банковскую карту"],
    "карточка": ["карта", "банковская карта"],
}
